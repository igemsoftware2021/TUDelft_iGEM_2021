...
if __name__ == "__main__":
    ...
    PARAMETER_SETUP = """tbd = 1  # Placeholder for unkown parameters/concentrations so that they're easy to find
...
"""
    ...
    SETUP_CODE_1 = """
import numpy as np
from __main__ import euk_model"""
    SETUP_CODE_2 = """
import numpy as np
from __main__ import njit_euk_model"""
    SETUP_CODE_3 = """
import numpy as np
from __main__ import njit_euk_model_one"""

    FUNC_1 = """euk_model(parameters, dt, t_tot, dna_i, vit_i, s_i)"""
    FUNC_2 = """njit_euk_model(parameters, dt, t_tot, dna_i, vit_i, s_i)"""
    FUNC_3 = """njit_euk_model_one(parameters, dt, t_tot, dna_i, vit_i, s_i)"""

    TEST_CODE_1 = PARAMETER_SETUP + FUNC_1
    TEST_CODE_2 = PARAMETER_SETUP + FUNC_2
    TEST_CODE_3 = PARAMETER_SETUP + FUNC_3

    print(timeit.repeat(setup=SETUP_CODE_1, stmt=TEST_CODE_1, number=1, repeat=1))
    print(timeit.repeat(setup=SETUP_CODE_2, stmt=TEST_CODE_2, number=1))
    print(timeit.repeat(setup=SETUP_CODE_3, stmt=TEST_CODE_3, number=1))
