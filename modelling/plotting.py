...
#     ax1.plot(time, mu_star_1, label="mu_star", color="#E389BB")
#     ax1.plot(time, mu_star_2, label="mu_star", color="#9B0138")
#     # plt.plot(time, sigma_1, label="sigma", color="#667817")
#     # plt.plot(time, sigma_2, label="sigma", color="#FFCF39")
#     ax1.set_title(name)
#     ax1.set_ylim([0, 1])
#     ax1.legend(["mu_star 1 " + name, "mu_star 3 " + name])
#     ax1.set_xlabel("Time (s)"), ax1.set_ylabel("Product (uM)")
