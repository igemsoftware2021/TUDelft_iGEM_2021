...
with DatabaseInterfaceCleanSequences(path=database_path) as db:
    for sequence in tqdm(sequences_with_fold_change):
        ...
        db.update_column_value(
            TABLE_NAME, rowid_seq_unclvd_neg, "fold_change_standard_deviation", fold_change_sd)
        db.update_column_value(
        ...
        db.update_column_value(
            TABLE_NAME, rowid_seq_clvd_neg, "fold_change_standard_deviation", fold_change_sd)
        db.update_column_value(
        ...
        db.update_column_value(
            TABLE_NAME, rowid_seq_unclvd_pos, "fold_change_standard_deviation", fold_change_sd)
        db.update_column_value(
        ...
        db.update_column_value(
            TABLE_NAME, rowid_seq_clvd_pos, "fold_change_standard_deviation", fold_change_sd)
        db.update_column_value(
