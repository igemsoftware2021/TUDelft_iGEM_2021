...
pi.i2c_write_byte_data(i2c_handle, 0x0E, PPULSE)
...
pi.i2c_write_byte_data(i2c_handle, 0x0F, PDRIVE | PDIODE | PGAIN | AGAIN)
...
pi.i2c_write_byte_data(i2c_handle, 0x00, WEN | PEN | AEN | PON)

time.sleep(0.012)
print(pi.i2c_read_i2c_block_data(i2c_handle, 0x01, 10))
print(pi.i2c_read_byte_data(i2c_handle, 0x01))
stop = time.time() + 15
exit()
