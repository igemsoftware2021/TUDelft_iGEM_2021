...
# Heating pin
pin_heating = "placeholder"

# Constants for heating
k_u = 1000  # Ultimate gain, used for Ziegler-Nichols tuning of the PID controller
...
while time.time() == start + 120:
    ...
    duty_cycle = k_u * temperature_error[-1]
    ...
    ax1.plt.draw(temperature_time, temperature_error)
    fig1.show()
