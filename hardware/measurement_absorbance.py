...
i2c_multiplexer_select_channel(pi,
                               i2c_multiplexer_handle, i2c_sensor_3_channel)  # Switch to a sensor channel
...
write_absorbance_csv(timepoints, intensity)

fig1, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2)
ax1.plot(timepoints[0], intensity[0])
ax1.set_xlabel("Time [s]")
ax1.set_ylabel("Intensity")
ax1.grid()


ax2.plot(timepoints[1], intensity[1])
ax2.grid()
ax2.set_xlabel("Time [s]")
ax2.set_ylabel("Intensity")

ax3.plot(timepoints[2], intensity[2])
ax3.grid()
ax3.set_xlabel("Time [s]")
ax3.set_ylabel("Intensity")

ax4.plot(timepoints[3], intensity[3])
ax4.grid()
